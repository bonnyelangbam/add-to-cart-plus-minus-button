 ...
 * Plugin URI: https://wordpress.org/plugins/custom-add-to-cart-plus-minus-button/
...
class atc_Plus_Minus_Button {
	...
	public function __construct() {
		...
		add_action( 'wp_enqueue_scripts', array( $this, 'be_add_cart_quantity_plus_minus' ) );
	}
	...
	public function be_add_cart_quantity_plus_minus() {
		...
		wp_register_style( 'add-to-cart-plus-minus-button', plugins_url( 'plus-minus.css', __FILE__ ), array(), '1.0.0' );
